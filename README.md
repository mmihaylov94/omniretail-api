...
Built with **CodeIgniter 4 (PHP)** and **PostgreSQL**, it provides an **API-first** foundation for product management, inventory tracking, POS sales, order lifecycle workflows, and reporting.
...
- **PostgreSQL** stores operational data (products, inventory ledger, orders, users)
